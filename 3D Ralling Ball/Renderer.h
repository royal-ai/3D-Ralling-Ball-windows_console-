...
const short c_ConsoleCharSizeX = 2;//size of one char (in pixels)
const short c_ConsoleCharSizeY = 2;//size of one char (in pixels)这里是像素的长和宽吗
const float c_ConsoleCharAspectRatio = 2.0f / 2.0f;//used to correct pixel scale  像素宽除于长
#endif
